...
puts repeated_number_ranges([1, 2, 1, 1, 2]) == [[2, 3]] # added test
p repeated_number_ranges([1, 1, 2, 3, 3, 1, 1, 1, 3, 4]) == [[0, 1], [3, 4], [5, 7]] # added test
...
def fall_and_winter_birthdays(stu)
...
def care_bear_summary(calendar)
