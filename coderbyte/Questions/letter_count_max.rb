...
# has 2 e's (and 2 t's) and it comes before ever which also has 2 e's. 
# If there are no words with repeating letters return -1. Words will be separated by spaces. 

def letter_count_max(string)

end

p letter_count_max("Hello apple pie") == 'Hello'
p letter_count_max("No words") == -1